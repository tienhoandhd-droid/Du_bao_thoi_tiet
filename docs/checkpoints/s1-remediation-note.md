...
| `run_fts_eval_v1` remediation | **LIVE_APPLIED — PASS** |
...
Đã tạo và apply live remediation cho finding `run_fts_eval_v1`:
...
- `docs/checkpoints/s1-run-fts-eval-live-apply.md`
...
- migration record `20260629095000 / 023_harden_run_fts_eval_v1` exists.

Trạng thái: **LIVE_APPLIED — PASS**.

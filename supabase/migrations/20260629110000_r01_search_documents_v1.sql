-- CRAVE deploy migration: 20260629110000_r01_search_documents_v1
-- Semantic source ID: CRAVE-024 / R01-A02 / R01-A05R
-- Legacy source artifact:
--   supabase/legacy-migrations/numeric-source/024_secure_document_search_boundary.sql
-- Original source SHA-256:
--   332f55ff3c03f182752147ba7b62d5d5ad3ddfec5af770506a63c48fd6a86833
--
...
--
-- KHÔNG tự apply. Chỉ apply bằng `supabase db push --linked` sau dry-run,
-- Claude review và xác nhận exact change set.
